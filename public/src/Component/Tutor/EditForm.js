    ...
    <div className="editForm">
      ...
      <div class="uk-card uk-card-default uk-card-large uk-card-body">
        ...
        <div class="uk-child-width-expand@s uk-margin-top uk-text-left" >
          <div className="form-details">
            <label className="edit-course-name">Banner Image</label><br></br>
            <div className="overviewContain">
              <textarea
                name="overViewText"
                value={course.overViewText}
                onChange={(e) => onInputChange(e)}
                style={{ height: '120px', background: "#FFFFFF", boxShadow: "0px 0px 1px 1px #888888" }} className="edit-inputBatch" />
              <div   >
                {!imageInput ? (
