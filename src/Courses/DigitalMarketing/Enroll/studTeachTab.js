            ...
            <div className='uk-child-width-1-2 uk-grid'>
              ...
              <div>
                <button className='googleSign uk-text-left'>
                  <i className='fab fa-google fa-lg uk-margin-right'></i>Sign in
                  with Google
                </button>
                ...
                <Typography className={classes.enrolled}>
                  Not Enrolled yet ? Why Don't you Sign up quickly here
                </Typography>
                <Button
                  className='login-blue-button'
          ...
          <TabPanel value={value} index={1}>
            ...
            <div className='uk-child-width-1-2 uk-grid'>
              ...
              <div>
                ...
                <Button className='login-blue-button' onClick={handleClickOpen}>
                  {' '}
                  Sign Up{' '}
                </Button>
              </div>
