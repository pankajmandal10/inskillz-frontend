        ...
        return (
            <div className="card ">
              ...
              <p className="featured">Featured Courses</p>
                 <div className="row row-cols-2 row-cols-md-4 g-4 pt-5 mt-5">
                     <div className="col">
                 ...
                 <div className="row row-cols-2 row-cols-md-4 g-4 py-3 my-3">
                    <div className="col" >
                       ...
                       <p className="featuredSub" >12434 Course</p>
                    </div>
                    <div className="col">
                        <p className="featured-2">Course Name 02</p>
                        <p className="featuredSub">124 Course</p>
                    </div>
                    <div className="col">
                        <p className="featured-2">Course Name 03</p>
                        <p className="featuredSub">52434 Course</p>
                    </div>
                    <div className="col">
                        <p className="featured-2">Course Name 04</p>
                        <p className="featuredSub">92434 Course</p>
                    </div>
                </div>
